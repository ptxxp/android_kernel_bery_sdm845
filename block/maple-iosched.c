...
/* Tunables */
static const int sync_read_expire = 300;	/* max time before a read sync is submitted. */
...
static const int async_write_expire = 400;	/* ditto for write async, these limits are SOFT! */
